...
In order to install seqspec, follow our installation instructions [here](/pages/installation/python_packages.qmd#seqspec).
:::
...
:::{.highlight-section}
To get a get an assay-specific sample seq-spec file and tutorial, select your assay [here](/pages/seqspec/seqspec_tutorials.qmd).
:::
...
How you install **R** packages depends on whether you are using a **conda environment**. See our page on [conda environments](conda.qmd) to learn how conda can help with **version control** and **reproducibility**. If you’re working within a conda environment, follow the conda installation instructions. Otherwise, you can install  packages within your R script.
